            ...
            <div class="col-md-4">
                <div class="card p-3 py-4">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <div class="px-4 mt-1">
                            <p class="fonts">Saya mahasiswa semester 3 Politeknik Negeri Semarang. Jurusan Teknik Elektro Prodi Teknik Informatika yang memiliki ketertarikan pada bidang UI/UX Design</p>
                        </div>
                        <div class="buttons">
